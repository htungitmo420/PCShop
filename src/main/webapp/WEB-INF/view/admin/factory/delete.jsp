...
<head>
    ...
    <title>Delete Factory - NHT-PCSHOP</title>
        ...
        <main id="main-content">
            <div class="container-fluid p-4">
                ...
                <div class="page-header delete-header">
                    <h1><i class="fas fa-user-times me-2"></i>Delete Factory</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="/admin/factory">Factory</a>
                            </li>
                ...
                <div class="delete-card">
                    ...
                    <div class="delete-header">
                        <h3>Delete Factory with ID ${id}</h3>
                    ...
                    <form:form method="post" action="/admin/manufacturer/delete" modelAttribute="newFactory">
                        <form:hidden path="id"/>

                        <div class="delete-actions">
                            <a href="/admin/manufacturer" class="btn-cancel">
