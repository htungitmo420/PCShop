            ...
            <div class="container-fluid p-4">
                ...
                <div class="row mb-4">
                    <div class="col-md-4">
                        <div class="stats-card">
                            <div class="stats-icon"><i class="fas fa-industry"></i></div>
                            <div class="stats-content">
                                <h4>${factories.size()}</h4>
                                <p>Total Factories</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-container">
                    <div class="card-header-custom">
                        <h3><i class="fas fa-table"></i> Factory List</h3>
                        <a href="/admin/manufacturer/create" class="btn-create">
                            <i class="fas fa-plus-circle me-1"></i>Create New Factory
                        </a>
                    </div>
                    <c:choose>
                        <c:when test="${empty factories}">
                            <div class="empty-state-modern">
                                ...
                                <h3>No Factory Found</h3>
                                <p>Start by adding your first factory</p>
                            </div>
                        </c:when>
                        ...
                        <c:otherwise>
                            <table class="table align-middle">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 62%;">FACTORY NAME</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="/admin/manufacturer/update/${f.id}"
                                                   class="btn-action btn-edit">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <a href="/admin/manufacturer/delete/${f.id}"
