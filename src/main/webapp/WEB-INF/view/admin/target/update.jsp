...
<head>
    ...
    <title>Update Audience - NHT-PCSHOP</title>
        ...
        <main id="main-content">
            <div class="container-fluid p-4">
                ...
                <div class="page-header form-header mb-4">
                    <div>
                        <h1><i class="fas fa-user-friends me-2"></i>Update Audience</h1>
                ...
                <div class="form-card">
                    <div class="form-header d-flex align-items-center mb-4">
                        ...
                        <div>
                            <h3 class="mb-1"><i class="fas fa-user-friends me-2"></i>Audience Information</h3>
                            <p class="text-muted mb-0">Update the audience details below</p>
                        </div>
                    </div>
                    ...
                    <form:form method="post"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">
                                        <i class="fas fa-id-badge me-2"></i>Audience ID
                                    </label>
                                    <input type="text" class="form-control bg-light"
                                           value="${newTarget.id}" readonly/>
                                </div>
                            </div>
                        ...
                        <div class="form-actions mt-4">
                            ...
                            <button type="submit" class="btn-primary">
                                <i class="fas fa-save me-2"></i>Update Audience
                            </button>
                        </div>
